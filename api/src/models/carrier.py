...
class CarrierVerification(Base):
    ...
    mc_number: Mapped[str] = mapped_column(String(16), unique=True, index=True, nullable=False)
    ...
    insurance_bipd_on_file: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
    insurance_cargo_on_file: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
