...
class CallLog(Base):
    ...
    carrier_mc: Mapped[str | None] = mapped_column(String(16), index=True, nullable=True)
    ...
    initial_carrier_ask: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
    final_agreed_rate: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
    ...
    sentiment: Mapped[CarrierSentiment] = mapped_column(carrier_sentiment_enum, nullable=False)
    ...
    destination_requested: Mapped[str | None] = mapped_column(String(128), nullable=True)
